...
export function buildFrontendContractArtifacts(
  ...
  return {
    ...
    frontendAgentInstructions: [
      ...
      "8. 04-design-system/components/component-contracts.json",
      "9. 04-design-system/components/component-registry.json",
      "10. 04-design-system/patterns/pattern-contracts.json",
      "11. 04-design-system/patterns/pattern-registry.json",
      "12. 04-design-system/tokens/token-contracts.json",
      "13. 04-design-system/tokens/typography-system.json",
      "14. 06-frontend-agent-contract/data-contracts.json",
      "15. 06-frontend-agent-contract/data-operation-contracts.json",
      "16. 06-frontend-agent-contract/action-contracts.json",
      "17. 06-frontend-agent-contract/form-contracts.json",
      "18. 06-frontend-agent-contract/verification-contracts.json",
      "19. 06-frontend-agent-contract/production-integration-contracts.json",
      "20. 06-frontend-agent-contract/acceptance-criteria.json",
      "",
