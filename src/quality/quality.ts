...
function buildSpecCoverageAudit(input: QualityInput, readiness: ReadinessReport): Record<string, unknown> {
  ...
  const coverage = [
    ...
    coverageItem("contract_review", "Contract review and handoff", input.referenceSurfaces.dashboard.length > 0 && input.revision.revisionProtocol.length > 0, ["07-reference-surfaces/*.md", "10-revision/revision-protocol.md"], "Contract package includes review surfaces, governance, revision, simulation, and handoff artifacts."),
