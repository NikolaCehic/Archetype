...
The MCP server also exposes resources and prompts. Claude Code agents should list resources/prompts when they need current-phase context, review instructions, or test-first handoff copy without scanning the filesystem.
