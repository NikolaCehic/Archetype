...
5. If a `draft_contract` package is generated, read the draft artifacts and ask for approval or edits. Do not proceed to canonical spec, tests, or implementation from a draft package.
