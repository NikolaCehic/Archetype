...
try {
  ...
  for (const toolName of ["archetype_release_doctor", "archetype_run_lifecycle", "archetype_create_intake", "archetype_answer_clarification", "archetype_generate_package", "archetype_consumer_next_action", "archetype_submit_review", "archetype_phase_package", "archetype_validate_package", "archetype_summarize_package", "archetype_read_artifact", "archetype_verify_target", "archetype_plan_repair"]) {
