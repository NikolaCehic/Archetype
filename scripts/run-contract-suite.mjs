...
const tasks = [
  ...
  task("consumer-plane", "scripts/run-consumer-plane-contract.mjs", "tmp/consumer-plane-contract", ["fast", "full"]),
  task("session-console", "scripts/run-session-console-contract.mjs", "tmp/session-console-contract", ["fast", "full"]),
  task("agent-control-plane", "scripts/run-agent-control-plane-contract.mjs", "tmp/agent-control-plane-contract", ["fast", "full"]),
  ...
  task("action-specificity", "scripts/run-action-specificity-contract.mjs", "tmp/action-specificity-contract", ["fast", "full"]),
  ...
  task("target-stack", "scripts/run-target-stack-manifest-contract.mjs", "tmp/target-stack-manifest-contract", ["fast", "full"]),
