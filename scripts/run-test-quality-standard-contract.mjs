...
assert(Array.isArray(standard.required_test_behaviors) && standard.required_test_behaviors.length === 8, "test quality standard must expose all required behaviors.");
for (const expected of ["[data-archetype-screen]", "generic primary button", "screenshot byte size", "Search filters real visible results", "Visual evidence covers desktop, tablet, and mobile"]) {
