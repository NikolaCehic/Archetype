...
for (const expected of ["implementation-contract.md", "experience/route-map.json", "screens/screen-inventory.json", "design-system/tokens.json", "frontend-agent-contract/implementation-rules.json"]) {
