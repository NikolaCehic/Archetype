...
Generated Markdown doc pack for the Archetype plugin pivot.

## Files

- `AGENTS.md`
- `START_HERE.md`
- `prompts/codex-phase-01-cleanup.md`
- `prompts/codex-phase-02-cli.md`
- `prompts/codex-phase-03-output-contract.md`
- `prompts/codex-phase-04-mcp.md`
- `prompts/codex-phase-05-plugins.md`
...
- `templates/generated-claude-md.md`
- `templates/mcp-json.md`
