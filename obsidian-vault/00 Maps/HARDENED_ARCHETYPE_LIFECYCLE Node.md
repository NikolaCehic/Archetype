...
tags:
  ...
  - hub
status: active
source: HARDENED_ARCHETYPE_LIFECYCLE.md
---

# HARDENED_ARCHETYPE_LIFECYCLE Node

This is the central Obsidian node for the hardened lifecycle.

Source document:

- [[10 Post-Pivot Imports/Hardening Docs/HARDENED_ARCHETYPE_LIFECYCLE|HARDENED_ARCHETYPE_LIFECYCLE.md]]

Purpose:

```txt
Prevent weak context from becoming fake certainty.
```
